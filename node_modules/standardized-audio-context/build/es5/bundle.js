(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('automation-events'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/assertThisInitialized'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/objectWithoutProperties')) :
    typeof define === 'function' && define.amd ? define(['exports', 'automation-events', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/helpers/typeof', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/helpers/inherits', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/assertThisInitialized', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/objectWithoutProperties'], factory) :
    (global = global || self, factory(global.standardizedAudioContext = {}, global.automationEvents, global._classCallCheck, global._slicedToArray, global._typeof, global._defineProperty, global._createClass, global._possibleConstructorReturn, global._getPrototypeOf, global._inherits, global._regeneratorRuntime, global._asyncToGenerator, global._assertThisInitialized, global._toConsumableArray, global._objectWithoutProperties));
}(this, (function (exports, automationEvents, _classCallCheck, _slicedToArray, _typeof, _defineProperty, _createClass, _possibleConstructorReturn, _getPrototypeOf, _inherits, _regeneratorRuntime, _asyncToGenerator, _assertThisInitialized, _toConsumableArray, _objectWithoutProperties) { 'use strict';
    ...
    var createAddAudioNodeConnections = function createAddAudioNodeConnections(audioNodeConnectionsStore) {
      return function (audioNode, audioNoderRender, nativeAudioNode) {
        var activeInputs = [];
    ...
    var createAddAudioWorkletModule = function createAddAudioWorkletModule(createAbortError, createNotSupportedError, evaluateSource, exposeCurrentFrameAndCurrentTime, fetchSource, getBackupNativeContext, getNativeContext, ongoingRequests, resolvedRequests) {
      ...
      return (
        ...
        function () {
          function AudioBuffer(options) {
            ...
            var _DEFAULT_OPTIONS$opti = _objectSpread$1({}, DEFAULT_OPTIONS$1, {}, options),
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function AudioBufferSourceNode(context) {
            ...
            var mergedOptions = _objectSpread$2({}, DEFAULT_OPTIONS$2, {}, options);
    ...
    var deleteConnectionAtOutput = function deleteConnectionAtOutput(source, output) {
      ...
      try {
        for (var _iterator3 = audioNodeConnectionsOfSource.outputs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    var sanitizedOptions = function sanitizedOptions(options) {
      return _objectSpread$3({}, options, {
    ...
    var createAudioWorkletNodeConstructor = function createAudioWorkletNodeConstructor(audioNodeConstructor, createAudioParam, createAudioWorkletNodeRenderer, createNativeAudioWorkletNode, gainNodeConstructor, getNativeContext, isNativeOfflineAudioContext, nativeAudioWorkletNodeConstructor, wrapEventListener) {
      return (
        /*#__PURE__*/
        function (_audioNodeConstructor) {
          ...
          function AudioWorkletNode(context, name) {
            ...
            var nativeContext = getNativeContext(context);
            var isOffline = isNativeOfflineAudioContext(nativeContext);
            var mergedOptions = sanitizedOptions(_objectSpread$3({}, DEFAULT_OPTIONS$3, {}, options));
            var nodeNameToProcessorConstructorMap = NODE_NAME_TO_PROCESSOR_CONSTRUCTOR_MAPS.get(nativeContext);
    ...
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee(proxy, renderedBuffer, nativeOfflineAudioContext, options, processorConstructor, exposeCurrentFrameAndCurrentTime) {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                parameters = Array.from(proxy.parameters.keys()).reduce(function (prmtrs, name) {
                  return _objectSpread$4({}, prmtrs, _defineProperty({}, name, new Float32Array(128)));
                }, {});
      ...
      return function (name, options, processorConstructor) {
        ...
        function () {
          ...
          _regeneratorRuntime.mark(function _callee4(proxy, nativeOfflineAudioContext, trace) {
            ...
            return _regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 82:
                    _context4.prev = 82;
                    _context4.t9 = _context4["catch"](71);
                    _didIteratorError3 = true;
            ...
            }, _callee4, null, [[43, 54, 58, 66], [59,, 61, 65], [71, 82, 86, 94], [87,, 89, 93]]);
          }));
        ...
        function (_minimalBaseAudioCont) {
          ...
          _createClass(BaseAudioContext, [{
            ...
            value: function createPeriodicWave(real, imag) {
              ...
              return new periodicWaveConstructor(this, _objectSpread$5({}, constraints, {
                imag: imag,
                real: real
              }));
            }
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function BiquadFilterNode(context) {
            ...
            var mergedOptions = _objectSpread$6({}, DEFAULT_OPTIONS$4, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function ChannelMergerNode(context) {
            ...
            var mergedOptions = _objectSpread$7({}, DEFAULT_OPTIONS$5, {}, options);
    ...
    var sanitizedOptions$1 = function sanitizedOptions(options) {
      return _objectSpread$8({}, options, {
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function ChannelSplitterNode(context) {
            ...
            var nativeContext = getNativeContext(context);
            var mergedOptions = sanitizedOptions$1(_objectSpread$8({}, DEFAULT_OPTIONS$6, {}, options));
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function ConstantSourceNode(context) {
            ...
            var mergedOptions = _objectSpread$9({}, DEFAULT_OPTIONS$7, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function ConvolverNode(context) {
            ...
            var mergedOptions = _objectSpread$a({}, DEFAULT_OPTIONS$8, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function DelayNode(context) {
            ...
            var mergedOptions = _objectSpread$b({}, DEFAULT_OPTIONS$9, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function DynamicsCompressorNode(context) {
            ...
            var mergedOptions = _objectSpread$c({}, DEFAULT_OPTIONS$a, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function GainNode(context) {
            ...
            var mergedOptions = _objectSpread$d({}, DEFAULT_OPTIONS$b, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function IIRFilterNode(context, options) {
            ...
            var mergedOptions = _objectSpread$e({}, DEFAULT_OPTIONS$c, {}, options);
    ...
    function () {
      ...
      return function createIsSupportedPromise(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13) {
        return _ref.apply(this, arguments);
      };
    }();

    var createMediaElementAudioSourceNodeConstructor = function createMediaElementAudioSourceNodeConstructor(audioNodeConstructor, createNativeMediaElementAudioSourceNode, createNotSupportedError, getNativeContext, isNativeOfflineAudioContext) {
      return (
        /*#__PURE__*/
        function (_audioNodeConstructor) {
          ...
          function MediaElementAudioSourceNode(context, options) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(MediaElementAudioSourceNode).call(this, context, true, nativeMediaElementAudioSourceNode, null)); // Bug #63: Edge & Firefox do not expose the mediaElement yet.

            _this._mediaElement = options.mediaElement;
    ...
    var createMediaStreamAudioSourceNodeConstructor = function createMediaStreamAudioSourceNodeConstructor(audioNodeConstructor, createNativeMediaStreamAudioSourceNode, createNotSupportedError, getNativeContext, isNativeOfflineAudioContext) {
      return (
        /*#__PURE__*/
        function (_audioNodeConstructor) {
    ...
    var createMediaStreamTrackAudioSourceNodeConstructor = function createMediaStreamTrackAudioSourceNodeConstructor(audioNodeConstructor, createNativeMediaStreamTrackAudioSourceNode, createNotSupportedError, getNativeContext, isNativeOfflineAudioContext) {
      return (
        /*#__PURE__*/
        function (_audioNodeConstructor) {
    ...
    var createMinimalBaseAudioContextConstructor = function createMinimalBaseAudioContextConstructor(audioDestinationNodeConstructor, createAudioListener, eventTargetConstructor, wrapEventListener) {
      return (
        /*#__PURE__*/
        function (_eventTargetConstruct) {
      ...
      return (
        ...
        function (_minimalBaseAudioCont) {
          ...
          function MinimalOfflineAudioContext(options) {
            ...
            var _DEFAULT_OPTIONS$opti = _objectSpread$f({}, DEFAULT_OPTIONS$d, {}, options),
                length = _DEFAULT_OPTIONS$opti.length,
                numberOfChannels = _DEFAULT_OPTIONS$opti.numberOfChannels,
                sampleRate = _DEFAULT_OPTIONS$opti.sampleRate;
        ...
        if (nativeAudioWorkletNodeConstructor !== null) {
          try {
            ...
            var nativeAudioWorkletNode = createNativeAudioNode(nativeContext, function (ntvCntxt) {
              return isNativeOfflineAudioContext(ntvCntxt) && options.numberOfInputs !== 0 && options.numberOfOutputs === 0 ? new nativeAudioWorkletNodeConstructor(ntvCntxt, name, _objectSpread$g({}, options, {
                numberOfOutputs: 1,
                outputChannelCount: [1],
                parameterData: _objectSpread$g({}, options.parameterData, {
                  hasNoOutput: 1
                })
                  ...
                  if (unpatchedEventListener !== null) {
                    ...
                    if (patchedEventListener !== undefined) {
                      ...
                      args[1] = function (event) {
                        unpatchedEventListener(new ErrorEvent(args[0], _objectSpread$g({}, event, {
                          error: new Error()
                        })));
                      };
    ...
    var createNativeAudioWorkletNodeFakerFactory = function createNativeAudioWorkletNodeFakerFactory(auxiliaryGainNodeStore, connectMultipleOutputs, createIndexSizeError, createInvalidStateError, createNativeChannelMergerNode, createNativeChannelSplitterNode, createNativeConstantSourceNode, createNativeGainNode, createNativeScriptProcessorNode, createNotSupportedError, disconnectMultipleOutputs, exposeCurrentFrameAndCurrentTime, monitorConnections) {
      return function (nativeContext, baseLatency, processorConstructor, options) {
        ...
        var parameters = processorConstructor.parameterDescriptors === undefined ? [] : processorConstructor.parameterDescriptors.reduce(function (prmtrs, _ref2) {
          var name = _ref2.name;
          return _objectSpread$h({}, prmtrs, _defineProperty({}, name, new Float32Array(128)));
        }, {});
        var isActive = true;
    ...
    var createNativeConstantSourceNodeFactory = function createNativeConstantSourceNodeFactory(cacheTestResult, createNativeAudioNode, createNativeConstantSourceNodeFaker, testAudioScheduledSourceNodeStartMethodNegativeParametersSupport, testAudioScheduledSourceNodeStopMethodNegativeParametersSupport) {
      return function (nativeContext, options) {
    ...
    var createNativeConstantSourceNodeFakerFactory = function createNativeConstantSourceNodeFakerFactory(createNativeAudioBufferSourceNode, createNativeGainNode, monitorConnections) {
      return function (nativeContext, _ref) {
        ...
        var gainNode = createNativeGainNode(nativeContext, _objectSpread$i({}, audioNodeOptions, {
          gain: offset
        })); // Bug #5: Safari does not support copyFromChannel() and copyToChannel().
    ...
    var createNativeMediaStreamTrackAudioSourceNodeFactory = function createNativeMediaStreamTrackAudioSourceNodeFactory(createInvalidStateError, createNativeAudioNode) {
      return function (nativeAudioContext, _ref) {
    ...
    var createNativePannerNodeFakerFactory = function createNativePannerNodeFakerFactory(connectNativeAudioNodeToNativeAudioNode, createInvalidStateError, createNativeAudioNode, createNativeChannelMergerNode, createNativeGainNode, createNativeScriptProcessorNode, createNativeWaveShaperNode, createNotSupportedError, disconnectNativeAudioNodeFromNativeAudioNode, monitorConnections) {
      return function (nativeContext, _ref) {
        ...
        var channelMergerNode = createNativeChannelMergerNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
          channelInterpretation: 'speakers',
          numberOfInputs: 6
        }));
        var inputGainNode = createNativeGainNode(nativeContext, _objectSpread$j({}, audioNodeOptions, {
          gain: 1
        }));
        var orientationXGainNode = createNativeGainNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 1
        }));
        var orientationYGainNode = createNativeGainNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var orientationZGainNode = createNativeGainNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var positionXGainNode = createNativeGainNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var positionYGainNode = createNativeGainNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var positionZGainNode = createNativeGainNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var scriptProcessorNode = createNativeScriptProcessorNode(nativeContext, 256, 6, 0);
        var waveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$j({}, SINGLE_CHANNEL_OPTIONS, {
    ...
    var createNativeStereoPannerNodeFakerFactory = function createNativeStereoPannerNodeFakerFactory(createNativeChannelMergerNode, createNativeChannelSplitterNode, createNativeGainNode, createNativeWaveShaperNode, createNotSupportedError, monitorConnections) {
      ...
      var SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS = _objectSpread$k({}, SINGLE_CHANNEL_OPTIONS, {
        oversample: 'none'
      });
      ...
      var buildInternalGraphForMono = function buildInternalGraphForMono(nativeContext, inputGainNode, panGainNode, channelMergerNode) {
        ...
        var leftGainNode = createNativeGainNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var leftWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: leftWaveShaperCurve
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var panWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: DC_CURVE
        }));
        var rightGainNode = createNativeGainNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var rightWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
      ...
      var buildInternalGraphForStereo = function buildInternalGraphForStereo(nativeContext, inputGainNode, panGainNode, channelMergerNode) {
        ...
        var leftInputForLeftOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var leftInputForLeftOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: leftInputForLeftOutputWaveShaperCurve
        }));
        var leftInputForRightOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var leftInputForRightOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
        ...
        var rightInputForLeftOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var rightInputForLeftOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: rightInputForLeftOutputWaveShaperCurve
        }));
        var rightInputForRightOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var rightInputForRightOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$k({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
      ...
      return function (nativeContext, _ref) {
        ...
        var channelMergerNode = createNativeChannelMergerNode(nativeContext, _objectSpread$k({}, audioNodeOptions, {
          channelCount: 1,
          channelCountMode: channelCountMode,
          numberOfInputs: 2
        }));
        var inputGainNode = createNativeGainNode(nativeContext, _objectSpread$k({}, audioNodeOptions, {
          channelCount: channelCount,
          channelCountMode: channelCountMode,
          gain: 1
        }));
    ...
    var createNativeWaveShaperNodeFakerFactory = function createNativeWaveShaperNodeFakerFactory(createConnectedNativeAudioBufferSourceNode, createInvalidStateError, createNativeAudioNode, createNativeGainNode, isDCCurve, monitorConnections) {
      return function (nativeContext, _ref) {
        ...
        var inputGainNode = createNativeGainNode(nativeContext, _objectSpread$l({}, audioNodeOptions, {
          gain: 1
        }));
        var invertGainNode = createNativeGainNode(nativeContext, _objectSpread$l({}, audioNodeOptions, {
          gain: -1
        }));
        var outputGainNode = createNativeGainNode(nativeContext, _objectSpread$l({}, audioNodeOptions, {
          gain: 1
        }));
        var revertGainNode = createNativeGainNode(nativeContext, _objectSpread$l({}, audioNodeOptions, {
          gain: -1
        }));
        var disconnectNativeAudioBufferSourceNode = null;
        var isConnected = false;
      ...
      return (
        ...
        function (_baseAudioContextCons) {
          ...
          function OfflineAudioContext(a, b, c) {
            ...
            var _DEFAULT_OPTIONS$opti = _objectSpread$m({}, DEFAULT_OPTIONS$e, {}, options),
                length = _DEFAULT_OPTIONS$opti.length,
                numberOfChannels = _DEFAULT_OPTIONS$opti.numberOfChannels,
                sampleRate = _DEFAULT_OPTIONS$opti.sampleRate;
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function OscillatorNode(context) {
            ...
            var mergedOptions = _objectSpread$n({}, DEFAULT_OPTIONS$f, {}, options);
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(OscillatorNode).call(this, context, false, nativeOscillatorNode, oscillatorNodeRenderer)); // Bug #81: Edge, Firefox & Safari do not export the correct values for maxValue and minValue.
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function PannerNode(context) {
            ...
            var mergedOptions = _objectSpread$o({}, DEFAULT_OPTIONS$g, {}, options);
    ...
    var createPannerNodeRendererFactory = function createPannerNodeRendererFactory(connectAudioParam, createNativePannerNode, getNativeAudioNode, renderAutomation, renderInputsOfAudioNode) {
      return function () {
        ...
        function () {
          ...
          return function createPannerNode(_x, _x2, _x3) {
            return _ref.apply(this, arguments);
          };
        }();
      ...
      return (
        ...
        function () {
          function PeriodicWave(context, options) {
            ...
            var mergedOptions = _objectSpread$p({}, DEFAULT_OPTIONS$h, {}, options);
    ...
    var createStartRendering = function createStartRendering(audioBufferStore, cacheTestResult, getAudioNodeRenderer, renderNativeOfflineAudioContext, testAudioBufferCopyChannelMethodsOutOfBoundsSupport, wrapAudioBufferCopyChannelMethods, wrapAudioBufferCopyChannelMethodsOutOfBounds) {
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function StereoPannerNode(context) {
            ...
            var mergedOptions = _objectSpread$q({}, DEFAULT_OPTIONS$i, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function WaveShaperNode(context) {
            ...
            var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_OPTIONS$j;

            _classCallCheck(this, WaveShaperNode);

            var nativeContext = getNativeContext(context);

            var mergedOptions = _objectSpread$r({}, DEFAULT_OPTIONS$j, {}, options);
    ...
    var monitorConnections = createMonitorConnections(insertElementInSet, isNativeAudioNode$1);
    ...
    var exposeCurrentFrameAndCurrentTime = createExposeCurrentFrameAndCurrentTime(window$1); // The addAudioWorkletModule() function is only available in a SecureContext.

    var addAudioWorkletModule = isSecureContext ? createAddAudioWorkletModule(createAbortError, createNotSupportedError, createEvaluateSource(window$1), exposeCurrentFrameAndCurrentTime, createFetchSource(createAbortError), getBackupNativeContext, getNativeContext, new WeakMap(), new WeakMap()) : undefined;
    ...
    var isAnyAudioNode = createIsAnyAudioNode(AUDIO_NODE_STORE, isNativeAudioNode$1);
