...
export interface IMinimalBaseAudioContext extends TNativeEventTarget {
    ...
    addEventListener<K extends keyof IMinimalBaseAudioContextEventMap>(type: K, listener: (this: IMinimalBaseAudioContext, event: IMinimalBaseAudioContextEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof IMinimalBaseAudioContextEventMap>(type: K, listener: (this: IMinimalBaseAudioContext, event: IMinimalBaseAudioContextEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
    removeEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | EventListenerOptions): void;
}
//# sourceMappingURL=/build/es2018/interfaces/minimal-base-audio-context.d.ts.map